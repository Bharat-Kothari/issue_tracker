    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text=b'Letters, digits and @/./+/-/_ only.', unique=True, max_length=50, verbose_name=b'email', error_messages={b'unique': b'A email with that already exists.'})),
