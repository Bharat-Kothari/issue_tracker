...
urlpatterns = [
    ...
    url(r'^dash/logout/$', views.LogoutView.as_view(), name='logout'),
    ...
    url(r'^projects/update/(?P<pk>[0-9 ]+)/$', views.ProjectUpdate.as_view(), name='updateproject'),
    url(r'^projects/addstory/(?P<pk>[0-9 ]+)/$', views.AddStory.as_view(), name='addstory'),
