...
story = [
    url(r'^add/(?P<pk>[0-9 ]+)/$', views.project_member_check(views.AddStoryView.as_view()), name='addstory'),
    url(r'^update/(?P<pk>[0-9 ]+)/$', views.story_view_check(views.UpdateStoryView.as_view()), name='updatestory'),
    url(r'^view/(?P<pk>[0-9 ]+)/$', views.story_view_check(views.StoryView.as_view()), name='storyview'),
    url(r'^delete/(?P<pk>[0-9 ]+)/$', views.story_view_check(views.StoryDeleteView.as_view()), name='storydelete'),
]


project =[
    url(r'^update/(?P<pk>[0-9 ]+)/$', views.project_update_check(views.ProjectUpdateView.as_view()), name='updateproject'),
...
urlpatterns = [
    ...
    url(r'^project/settings/(?P<pk>[0-9 ]+)/$', views.project_update_check(views.ProjectSettingView.as_view()), name='project_settings'),
]
