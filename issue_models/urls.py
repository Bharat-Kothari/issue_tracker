...
urlpatterns = [
    ...
    url(r'^signup/$', views.login_check(views.SignupCreate.as_view()),name='signup'),
    ...
    url(r'^project/(?P<pk>[a-z0-9 ]+)/$', views.ProjectView.as_view(), name='project'),
    url(r'^projects/update/(?P<pk>[a-z0-9 ]+)/$', views.ProjectUpdate.as_view(), name='updateproject'),
    url(r'^projects/addstory/(?P<pk>[a-z0-9 ]+)/$', views.AddStory.as_view(), name='addstory'),
